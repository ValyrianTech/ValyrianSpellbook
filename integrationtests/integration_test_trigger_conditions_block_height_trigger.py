...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', f'-b={latest_block_height + 1}', '-c=0', '-st=Active')
...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', f'-b={latest_block_height}', '-c=0', '--reset')
assert response is None
...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', f'-b={latest_block_height - 3}', '-c=6', '--reset')
assert response is None
...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', f'-b={latest_block_height - 3}', '-c=3', '--reset')
assert response is None

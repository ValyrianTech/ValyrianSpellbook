...
response = spellbook_call('save_trigger', previous_trigger, f'-t={previous_trigger_type}', '-st=Active')
assert response is None

action_name = 'test_triggerstatus_action'
webhook = 'http://www.google.com'

response = spellbook_call('save_action', action_name, '-t=Webhook', f'-w={webhook}')
assert response is None
...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', f'-pt={previous_trigger}', f'-pts={previous_trigger_status}', '-st=Active')
assert response is None
...
response = spellbook_call('save_trigger', trigger_name, f'-pts={previous_trigger_status}')
assert response is None

...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', '-st=Active')
...
print(f'{signature} {len(signature)}')
...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', '--reset', f'-a={wrong_address}')
assert response is None
...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', '--reset', f'-a={address}')
assert response is None
...
script = 'Template.py'
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', '--reset', '-a={}'.format(''), '--multi', f'-sc={script}')
assert response is None

...
response = spellbook_call('save_trigger', trigger_name, f'-t={trigger_type}', f'-bt={begin_time}', f'-et={end_time}', f'-i={interval}', '-st=Active')
...
while int(time.time()) < end_time - 5:
    ...
    print(f'Number of times triggered should be {n_triggered} now')

...
def get_lal(address, xpub, block_height=0, explorer=None):
    ...
    sil_data = get_sil(address, block_height, explorer)
...
def get_lbl(address, xpub, block_height=0, explorer=None):
    lal_data = get_lal(address, xpub, block_height, explorer)
    ...
    for i in range(0, len(lal)):
        address = lal[i][0]
        linked_balance = balance(lal[i][1], explorer)
...
def get_lrl(address, xpub, block_height=0, explorer=None):
    lal_data = get_lal(address, xpub, block_height, explorer)
...
def get_lsl(address, xpub, block_height=0, explorer=None):
    lal_data = get_lal(address, xpub, block_height, explorer)

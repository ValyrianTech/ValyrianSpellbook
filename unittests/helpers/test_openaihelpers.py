...
class TestOpenAIHelpers(unittest.TestCase):
    ...
    def test_get_model_ids_error(self, mock_enable):
        ...
        with patch('helpers.openaihelpers.openai.Model.list', side_effect=ValueError("API Error")):
    ...
    def test_openai_complete_error(self, mock_enable):
        ...
        with patch('helpers.openaihelpers.openai.Completion.create', side_effect=ValueError("API Error")):
    ...
    def test_openai_chat_complete_error(self, mock_enable):
        ...
        with patch('helpers.openaihelpers.openai.ChatCompletion.create', side_effect=ValueError("API Error")):
    ...
    def test_openai_edit_error(self, mock_enable):
        ...
        with patch('helpers.openaihelpers.openai.Edit.create', side_effect=ValueError("API Error")):
